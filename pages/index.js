  ...
  return (
    <>
      ...
      <section className="min-h-96 relative flex flex-1 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-gray-100 py-16 shadow-lg md:py-20 xl:py-48">
        <Image src="https://images.unsplash.com/photo-1618004652321-13a63e576b80?auto=format&q=75&fit=crop&w=1500" loading="lazy" alt="Photo by Fakurian Design" className="absolute inset-0 h-full w-full object-cover object-center" width={1500} height={1000} />
        ...
        <div className="relative flex flex-col items-center p-4 sm:max-w-xl">
          ...
          <h1 className="mb-8 text-center text-4xl font-bold text-white sm:text-5xl md:mb-12 md:text-6xl">Revolutionary way to manage Sales</h1>
            ...
            <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
              ...
              <div className="grid gap-8 sm:grid-cols-2 sm:gap-y-10 xl:grid-cols-3">
                <div className="relative rounded-lg bg-gray-100 p-5 pt-8">
                  ...
                  <p className="text-gray-500">SynergySells is an AI-powered sales tool that generates compelling sales pitches that close deals in real-time.</p>
                </div>
                ...
                <div className="relative rounded-lg bg-gray-100 p-5 pt-8">
                  ...
                  <p className="text-gray-500">The main feature of SynergySells is the AI-powered copywriting tool that helps generate sales copy quickly and easily.</p>
                </div>
                ...
                <div className="relative rounded-lg bg-gray-100 p-5 pt-8">
                  ...
                  <p className="text-gray-500">SynergySells integrates with popular CRM and marketing tools such as Salesforce and Mailchimp.</p>
                </div>
                ...
                <div className="relative rounded-lg bg-gray-100 p-5 pt-8">
                  ...
                  <p className="text-gray-500">Support is available 24/7 through email and chat.</p>
                </div>
                ...
                <div className="relative rounded-lg bg-gray-100 p-5 pt-8">
                  ...
                  <p className="text-gray-500">Users can upgrade their plan at any time from their account dashboard.</p>
                </div>
                ...
                <div className="relative rounded-lg bg-gray-100 p-5 pt-8">
                  ...
                  <p className="text-gray-500">SynergySells accepts all major credit cards and PayPal for payment.</p>
                </div>
              </div>
            </div>
          </div>
