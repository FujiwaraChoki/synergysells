        ...
        <div class="bg-white py-6 sm:py-8 lg:py-12" id="features">
            <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                <div class="mb-10 md:mb-16">
                    ...
                    <p class="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">{config.features.description}</p>
                </div>
                ...
                <div class="grid gap-4 sm:grid-cols-2 md:gap-8 xl:grid-cols-3">
                    <div class="flex flex-col rounded-lg border p-4 md:p-6">
                        ...
                        <p class="mb-4 text-gray-500">{config.features?.growth}</p>
                    ...
                    <div class="flex flex-col rounded-lg border p-4 md:p-6">
                        ...
                        <p class="mb-4 text-gray-500">{config.features.security}</p>
                        <a href="#" class="mt-auto font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">More</a>
                    </div>
                    <div class="flex flex-col rounded-lg border p-4 md:p-6">
                        <div class="mb-2 flex h-12 w-12 items-center justify-center text-indigo-500 sm:mb-4 md:h-14 md:w-14">
                        ...
                        <p class="mb-4 text-gray-500">{config.features.cloud}</p>
                        <a href="#" class="mt-auto font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">More</a>
                    </div>
                    <div class="flex flex-col rounded-lg border p-4 md:p-6">
                        <div class="mb-2 flex h-12 w-12 items-center justify-center text-indigo-500 sm:mb-4 md:h-14 md:w-14">
                        ...
                        <p class="mb-4 text-gray-500">{config.features.speed}</p>
                        <a href="#" class="mt-auto font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">More</a>
                    </div>
                    <div class="flex flex-col rounded-lg border p-4 md:p-6">
                        <div class="mb-2 flex h-12 w-12 items-center justify-center text-indigo-500 sm:mb-4 md:h-14 md:w-14">
                        ...
                        <p class="mb-4 text-gray-500">{config.features.support}</p>
                        <a href="#" class="mt-auto font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">More</a>
                    </div>
                    <div class="flex flex-col rounded-lg border p-4 md:p-6">
                        <div class="mb-2 flex h-12 w-12 items-center justify-center text-indigo-500 sm:mb-4 md:h-14 md:w-14">
                        ...
                        <p class="mb-4 text-gray-500">{config.features.dark_mode}</p>
                        <a href="#" class="mt-auto font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">More</a>
                    </div>
                </div>
            </div>
