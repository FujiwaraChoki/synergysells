...
const Navbar = () => {
    ...
    return (
        <header className="mb-4 flex items-center justify-between py-4 md:py-8">
            ...
            }} className={`hidden rounded-lg bg-gray-200 px-8 py-3 text-center text-sm font-semibold outline-none ring-indigo-300 transition duration-100 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base lg:inline-block ${isActive('about')}`}>{config.nav.contact}</Link>
